...
def main(args):
    prefix = 933  # Replace the prefix with your own prefix as an integer (default: None)
    ...
    deckJSON = "/Users/kelvintran/GithubRepos/yycnetlabs-anki/CCNP-ENCOR_v8/CCNP-ENCOR_v8.json"  # Replace the file name with the FULL file name (including file extensions) of the deck JSON file. Absolute or relative paths allowed. (default: None)
    ...
    if importFromFile:
        if args.f is not None:
            ...
            importJSON = "/Users/kelvintran/Desktop/template622020.json"  # Replace the file name with the file name of the imported JSON file. Absolute or relative paths work.
